...
class KNearestNeighbor(object):
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in xrange(num_test):
      ...
      #######################################################################
      # X[i] - self.X_train makes use of broadcasting
      # need axis=1 in sum in order to sum over the individual pixel Euclidean
      # distances instead of summing up all the values
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      lab = [k for k,v in cnt.items() if v == max_val]
      lab.sort()
      y_pred[i] = lab[0]
